<template>
  <div class="bg-stone-50">
    <div class="relative h-[350px] md:h-[450px] overflow-hidden">
      <img :src="tipoImagen" alt="Transporte San Luis" class="w-full h-full object-cover" />
    ...
    <section class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-12">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold text-stone-900">Transporte</h1>
        <hr class="border-stone-300 my-4 max-w-md mx-auto" />
        <p class="text-stone-500 max-w-xl mx-auto leading-relaxed">
          Encuentra opciones de transporte para llegar y moverte en San Luis. Empresas de buses, mototaxis y más.
        </p>
      </div>
