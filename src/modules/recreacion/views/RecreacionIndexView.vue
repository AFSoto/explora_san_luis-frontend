<template>
  <div class="bg-stone-50">
    <div class="relative h-[350px] md:h-[450px] overflow-hidden">
      <img :src="tipoImagen" alt="Recreación San Luis" class="w-full h-full object-cover" />
    ...
    <section class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-12">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold text-stone-900">Recreación</h1>
        <hr class="border-stone-300 my-4 max-w-md mx-auto" />
        <p class="text-stone-500 max-w-xl mx-auto leading-relaxed">
          Disfruta de las mejores actividades recreativas en San Luis. Piscinas, balnearios, parques y diversión para toda la familia.
        </p>
      </div>
